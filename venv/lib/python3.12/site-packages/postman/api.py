...
def pm_broadcast(
    ...
    recipients: 'AbstractUser | list[AbstractUser] | tuple[AbstractUser]',
    subject: str,
    body: str = '',
...
@sensitive_variables('subject', 'body')
def pm_write(sender: 'AbstractBaseUser', recipient: 'AbstractBaseUser', subject: str, body: str = '',
        skip_notification: bool = False, auto_archive: bool = False, auto_delete: bool = False,
        auto_moderators: 'AutoModeratorsAlias | None' = None):
    """
