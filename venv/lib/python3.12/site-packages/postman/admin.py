...
if TYPE_CHECKING:
    ...
    _ModelAdminAlias = admin.ModelAdmin[Message]
else:
    _ModelAdminAlias = admin.ModelAdmin
...
class MessageAdmin(_ModelAdminAlias):
    ...
    def save_model(self, request: 'HttpRequest', obj: 'Message', form: Any, change: Any):
        """
        ...
        """
        obj.clean_moderation(form.initial_status, cast('AbstractBaseUser', request.user))
...
class PendingMessageAdmin(MessageAdmin):
    ...
    def has_delete_permission(self, request: 'HttpRequest', obj: 'Message | None' = None):
